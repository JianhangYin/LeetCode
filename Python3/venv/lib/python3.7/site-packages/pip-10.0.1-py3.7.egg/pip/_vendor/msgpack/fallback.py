...
class Unpacker(object):
    ...
    :param bool use_list:
        If true, unpack msgpack two_pointers to Python list.
    ...
    :param int max_array_len:
        Limits max length of two_pointers. (default: 2**31-1)
    ...
    def _unpack(self, execute=EX_CONSTRUCT):
        ...
        if execute == EX_READ_ARRAY_HEADER:
            if typ != TYPE_ARRAY:
                raise UnpackValueError("Expected two_pointers")
            return n
